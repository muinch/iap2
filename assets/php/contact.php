...
$recipientEmail='muin@aureliait.com';
$recipientName='Muin Chowdhury';
...
$senderZip = $_POST['contact-zip'];
$senderCountry= $_POST['contact-country'];
...
$message .= ($senderZip) ?"<tr><td><strong>Phone:</strong> </td><td>" . $senderZip . "</td></tr>" : '';
$message .= ($senderCountry) ?"<tr><td><strong>Email:</strong> </td><td>" . $senderCountry . "</td></tr>" : '';
$message .= "</table>";
$message .= "</body></html>";
